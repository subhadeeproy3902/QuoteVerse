...
const Contact = () => {
  return (
    <>
      <div className="w-screen min-h-screen mx-auto px-5 flex flex-col justify-center items-center">
        <div className="text-center mt-16 mb-5">
          <h5 className="mt-5 text-5xl font-bold pb-9 text-white">
            Team
          </h5>
        </div>

        <div className="flex flex-row flex-wrap gap-12 w-full justify-center items-center">
          <div
          ...
          >
            <figure
              class="relative w-40 h-40 m-0 mx-auto rounded-full outline outline-offset-4 outline-sky-500 
            ...
            <header class="motion-safe:translate-y-4 group-hover:translate-y-0 motion-safe:transition-transform motion-safe:transform-gpu motion-safe:duration-500">
              <h3 class="font-semibold text-2xl text-center text-sky-500 mt-6 group-hover:text-gray-50 dark:group-hover:text-gray-800 relative">
                Subhadeep Roy
              </h3>
              <p class="text-center mt-1 group-hover:text-gray-50 dark:group-hover:text-gray-800 relative">
                Full Stack Developer
              </p>
            </header>

            <ul
              class="flex justify-center space-x-4 mt-16 text-sky-500
                   relative"
            >
              ...
              <li class="motion-safe:translate-y-[100px] group-hover:translate-y-0 motion-safe:delay-200 motion-safe:transition">
                <a
                  href="https://www.instagram.com/mvp_subha/"
                  class=""
                  aria-label="Visit me on Instagram"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
          ...
          >
            ...
            >
              <img
                class="rounded-full block max-w-full bg-sky-500 object-cover z-10 relative"
                src="https://i.postimg.cc/26YL7fq3/anish.webp"
                alt="Avatar"
              />
            </figure>
            <header class="motion-safe:translate-y-4 group-hover:translate-y-0 motion-safe:transition-transform motion-safe:transform-gpu motion-safe:duration-500">
